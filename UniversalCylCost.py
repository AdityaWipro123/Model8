...
model = joblib.load("./model8_fin.pkl")
...
input_headers = [
    "Bore", "Rod diameter", "Stroke","CEC_Thickness","HEC-OD","HEC_Thickness","Rod_Length",
    "BearingY-N"
]
...
if st.button("Predict Cost 💰"):
    ...
    input_data = pd.DataFrame([[
        bore, rod_dia, stroke,cec_thickness,hec_od,hec_thickness, rod_length,
        bearing_map[bearing]
    ]], columns=input_headers)
